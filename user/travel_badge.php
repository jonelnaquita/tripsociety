                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2 d-flex justify-content-center align-items-center">
                                            <div class="icon-container position-relative">
                                                <i class="fas fa-certificate text-white" style="font-size: 30px;"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control text-white"
                                                    style="background-color: #3300cc; border: none; font-size: 13px;"
                                                    value="Discover Museo ni Miguel Malvar in Sto. Tomas" readonly>
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-white museo-miguel-malvar"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control text-white"
                                                    style="background-color: #3300cc; border: none; font-size: 13px;"
                                                    value="Visit Apolinario Mabini Museum in Tanauan City" readonly>
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-white apolinario-mabini-museum"
                                                        style="background-color: #3300cc;"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control text-white"
                                                    style="background-color: #3300cc; border: none; font-size: 13px;"
                                                    value="Unwind at Canyon Cove Hotel and Spa in Nasugbu" readonly>
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-white canyon-cove-hotel-and-spa"
                                                        style="background-color: #3300cc;"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control text-white"
                                                    style="background-color: #3300cc; border: none; font-size: 13px;"
                                                    value="Rejuvenate at Camp Laiya Resort in San Juan" readonly>
                                                <div class="input-group-append">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control text-white"
                                                    style="background-color: #3300cc; border: none; font-size: 13px;"
                                                    value="Discover Caleruega Retreat House in Nasugbu" readonly>
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-white caleruega-retreat-house"
                                                        style="background-color: #3300cc;">0/1</span>
                                                </div>
                                            </div>
                                        </div>
