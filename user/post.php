            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        // Get the first post and its comments
                        var post = response[0];
                        ...
                        <div class="post-header d-flex align-items-center mb-3">
                            ...
                            <div class="ms-3 ml-2">
                                ...
                                <small class="text-muted">@${post.username} • ${post.location}</small>
                            </div>
                        </div>
                    `;
                    ...
                    `;
                        ...
                        var hasReacted = post.user_reacted; // Assuming 'has_reacted' is part of the response
                        var heartIconClass = hasReacted ? 'fas' : 'far'; // Use 'fas' if reacted, else 'far'
                    ...
                    `;
                        $('.post-actions').append(postActionsHtml); // Append the new actions
