...
<div class="login-box">
  ...
  <div class="card shadow-none">
    ...
    <p class="login-box-msg font-weight-bold" style="font-size:25px; line-height: 1.1;">Reset Password</p>
    ...
    <div class="form-group has-feedback" style="position: relative;">
        ...
        <div class="col-6 login-btn">
            <a type="button" href="index.php" class="btn btn-outline-secondary btn-block" style="border-radius:25px;">
              CANCEL
            </a>
          </div>
          <div class="col-6 login-btn">
            <button type="submit" class="btn btn-primary btn-block" name="reset_password">
