                        ...
                        <div class="col m-auto">
                            <div class="card m-auto" style="background-color:#6CB4EE;">
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control mt-2" placeholder="Add comment" rows="4"
                                    ...
                                    <div class="text-center mt-3">
                                        ...
                                        if (isset($_SESSION['user'])) {
                                            ...
                                            <button class="btn btn-dark btn-block"
                                                style="border-radius:25px; background-color:#002D62;" type="submit"
                                                name="add_feedback">SUBMIT NOW</button>
                                            <?php
                                        } else {
                                            ?>
