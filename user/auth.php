...
<div class="login-box">
  ...
  <div class="card shadow-none">
    <div class="card-body login-card-body">
      <p >Don't worry it happens. Kindly enter the Email Address associated with your account</p>
      ...
      <div class="form-group has-feedback" style="position: relative;">
        ...
        <div class="col-6 login-btn">
            <a type="button" href="index.php" class="btn btn-secondary btn-block">
              CANCEL
            </a>
          </div>
          <div class="col-6 login-btn">
            <button type="submit" class="btn btn-outline-secondary btn-block" name="verify_email">
