                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            foreach ($improvements as $improvement) {
                                                                if (trim($improvement != 0)) {
                                                                    echo '<span class="badge badge-primary" style="font-size:12px;">' . htmlspecialchars(trim($improvement)) . '</span> ';
                                                ...
                                                <div class="col mr-auto text-right">
                                                    ...
                                                    <br>
                                                    <button class="btn btn-outline-dark btn-sm mt-2 mr-2 respond-button"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <p style="font-size:15px;"><?php echo htmlspecialchars($row['feedback']); ?>
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row response-display">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <textarea name="message" class="form-control" rows="2"
                                                                style="font-size:12px;" placeholder="Type your response here..."
                                                                required></textarea>
                                            ...
                                            <?php if ($response): ?>
                                                <div class="row response-display">
                                                    <div class="col-auto mt-2">
                                                        <img src="../dist/img/avatar4.png" style="width:30px;" class="img-circle"
                                                            alt="">
                                                    </div>
                                                    <div class="col">
                                                        <span class="font-weight-bold text-muted"
                                                        ...
                                                        <p style="font-size:15px;">
                                                            <?php echo htmlspecialchars($response['message']); ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
