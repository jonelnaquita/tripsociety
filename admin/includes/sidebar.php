<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href="dashboard.php">
            ...
            <span class="ms-1 text-sm text-dark">Trip Society</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="location.php">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="announcement.php">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-dark w-100" href="logout.php" type="button">Sign
                Out</a>
        </div>
    </div>
</aside>